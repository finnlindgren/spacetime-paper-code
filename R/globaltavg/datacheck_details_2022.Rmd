...
tk0 <- c(0, 1:25*13, 365); t0m <- (tk0[-1]+tk0[-length(tk0)])/2
...
plot(x0 - 0.2, ndat3t[tt0,1], type='h', col='blue',
...
axis(2)
legend("top", names.vars[c(1,3,2)], col= c("blue", "green", "red"), 
...
for(i in 1:nvars) {
    ...
    legend(-180, -32, llabs[[i]], col=pcolors, #bty='n',
